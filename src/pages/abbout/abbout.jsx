...
import misionlogo from "../../imgs/missions.jpg"
import visionlogo from "../../imgs/vision.jpeg"
import aus from "../../imgs/us.png"


import abigail from "../../imgs/participants/abigail.JPG"
import abigail2 from "../../imgs/participants/abigail2.jpg"

function abbout() {
     console.log("jajksdha")
    return (
        <html>
            <body >
                {/*image carrouseel*/}
                ...
                <br />
                <center>
                    <t1 className="tex1"> Acerca de Nosotros </t1>
                </center>
                <div className="acerca">
                    <Card style={{ width: '25rem' }}>
                        <Card.Img variant="top" src={misionlogo} />
                        <Card.Body>
                    ...
                    <Card style={{ width: '25rem' }}>
                        <Card.Img variant="top" src={visionlogo} />
                        <Card.Body>
                            <Card.Title>vision</Card.Title>
                            <Card.Text>
                                We seek to deliver opportunities that will change lives in the areas of professional trainings, as well as
                                physical, and mental education, consequently, supporting each individual to reach their greatest
                                potential. 
                            </Card.Text>
                        </Card.Body>
                    </Card>
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="card">
                                    ...
                                    <div className="img2"><img src={abigail} alt="" /></div>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <div className="img3"><img src="https://media.discordapp.net/attachments/985659106796929095/1011082509381030000/Fondo.jpg" alt="" /></div>
                                    <div className="img2"><img src={abigail2} alt="" /></div>
                                    <div className="main-text1">
                                    <h3>Nombre</h3>
                                    <p> puesto</p>
                                    <p> conocimiento</p>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <div className="img3"><img src="https://media.discordapp.net/attachments/985659106796929095/1011082509381030000/Fondo.jpg" alt="" /></div>
                                    <div className="img2"><img alt="" /></div>
                                    <div className="main-text1">
                                    <h3>Nombre</h3>
                                    <p> puesto</p>
                                    <p> conocimiento</p>
