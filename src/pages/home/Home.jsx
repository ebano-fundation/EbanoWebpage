...
//importing dominican map from imgs

import Dominicana from '../../imgs/do-03.png';
    ...
    return (
        <html onload={hometranslator}>
            ...
            <div className="transition">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 1200 19.07">
            ...
            <body>
                {/* Welcome */ }
                <center>
                    <div className='welcomesectiom'>
                        <div className="welcomecontainer">
                            { /*welcome to ebano  div */}
                            <h3 className="welcomeh3" id="welcome">Welcome To Ebano</h3>
                            <h2 className = "welccomeh2" id ="wlcomequote">  </h2>
                        </div>
                    </div>
                    { /*presentation */}
                    <div className ="presentation">
                        <div className="presncon">
                            <img className="rd" src={Dominicana} alt="dominicana" />
                            <div className="goaltext">
                                <t1 className='goal' id='goals'> 
                                    We want to bring help to those who need it
                                    to help those children who need a light in their lives
                                </t1>
                            </div>
                    ...
                    <div className="Mission">
                        <div class="container">
                            <div class="content">
                                <div Style="background-color:rgb(4,213,237);  width:120%; posirion:relative; transform:translateX(-8%) ">
                                    <center>
                                        <t1 id='health'>Health</t1>
                                    </center>
                                </div>
                                <div className="description">
                                    <center>
                                        <h4 id='health-info'> supplying the kids with medicine and health care </h4>
                                        <button className='discoverhealth'> Discover more</button>
                                    </center>
                                </div>
                            </div>
                            <div class="flap"></div>
                        ...
                        <div class="container">
                            <div class="content">
                                <div Style="background-color:rgb(255,255,0);  width:120%; posirion:relative; transform:translateX(-8%) ">
                                    <center>
                                        <t1 id='happines'>Happines</t1>
                                    </center>
                                </div>
                                <div className="description">
                                    <center>
                                        <h4 id='happines-info'> Estamos para brindarle la posibilidad de un mejor futuro a los niños del pais</h4>
                                        <button className='discoverhappines'> Discover more</button>
                                    </center>
                                </div>
                            </div>
                            <div class="flap2"></div>
                        ...
                        <div class="container">
                            <div class="content">
                                <div className='txt'>
                                    <div Style="background-color:rgb(50, 205, 50);  width:120%; posirion:relative; transform:translateX(-8%) ">
                                        <center>
                                            <t1 id='education' >
                                                Education
                                            </t1>
                                ...
                                <div className="description">
                                    <h4 id='education-info'> dedicating our time to bring the tools to open the educational breach to all unfotunated kids in our island </h4>
                                    <button className='discovereducation'> Discover more</button>
                                </div>
                            </div>
                            <div class="flap3">
                            </div>
                    ...
                    <div className="recent-charity">
                        <iframe onClick="gotourl()" src="https://www.youtube.com/embed/BKJtpGqy_W0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;  picture-in-picture" allowfullscreen></iframe>
                    </div>
                </center>
            </body>
        </html>
