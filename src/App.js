...
//import child from './imgs/IMG_1399.jpeg'
//import church from './imgs/IMG_2846.jpeg'
import './css/App.css';
//import { Button, Collapse } from 'react-bootstrap';
//import { Carrousel, Modal } from 'bootstrap'
//import lang from './index'
//import background from './imgs/background.bmp'
//import des from './imgs/birds.png';
import './css/carrousel.Sass'
...
function slideshow()
{
    ...
    setTimeout(slideshow, 10000)
     ...
     //esta es de la seccion slideshow-container
     <a className="next" onClick="plusSlides(-1)">&#10091;</a>
     <a className="prev" onClick="plusSlides(1)">&#10090;</a>
*/

function Example() {
    const [open, setOpen] = this.useState(0);
}
            ...
            <body>
                ...
                <center>
                    ...
                    <div classname="container2 ">
                        <div className='duty'>
                            <h3>Welcome to Ebano </h3>
                            <t1>
                                we are heare to bring the posibilities for al the kids in the island
                            </t1>
                        </div>
                    </div>
                    ...
                    <div className="Mission">
                        <div class="container">
                            <div class="content">
                                <t1>Our duty</t1>
                                <h3>we dedicate our time to bring happines and hope to all unfotunated kids in our island</h3>
                            </div>
                            <div class="flap"></div>
                            <t1>
                                education
                        ...
                        <div class="container">
                            <div class="content">
                                <div Style="background-color:rgb(38, 204, 140);  width:120%; posirion:relative; transform:translateX(-8%) ">
                                    <center>
                                        <t1 >
                                            education
                                        </t1>
                                ...
                                <h3>we dedicate our time to bring the tools to open the educational breach to all unfotunated kids in our island</h3>
                            </div>
                            <div class="flap3">
                            </div>
                        </div>
                    ...
                    {/*youtube video abbout the latest charity */}
                <div className="recent-charity">
                        <iframe onClick="gotourl()" src=" https://www.youtube.com/embed/c4WwSXZ97tQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;  picture-in-picture" allowfullscreen></iframe>
                </div>
